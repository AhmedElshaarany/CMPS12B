...
//-----------------------------------------------------------------------------
// Description:
// A test for the different methods of the generic List ADT
//----------------------------------------------------------------------------
...
public class ListTest{
   ...
   public static void main(String[] args){
      ...
      //************************* testing isEmpty(), and size() methods ********************************//
       ...
       System.out.println("Num of items in A = "+A.size());
       */
      ...
      */
      ...
      //******************** testing add(), equals(), size(), remove(), get(), toString(), and removeAll() methods *****************//
      ...
      */
      ...
      //************************* testing the whole ListClient.java ********************************//
